...
export default function Sim3SceneView({ executeResult, liveCode, onTestInput, onComplete }: Props) {
  ...
  const animRef = useRef<ReturnType<typeof globalThis.setTimeout>[]>([])
  const novaTimersRef = useRef<ReturnType<typeof globalThis.setTimeout>[]>([])
