...
export default function Sim2SceneView({
  executeResult,
  liveCode,
  sessionKey,
  onComplete,
  ...
  const hintDismissRef = useRef<ReturnType<typeof globalThis.setTimeout> | null>(null)
  const hintReshowRef = useRef<ReturnType<typeof globalThis.setTimeout> | null>(null)
