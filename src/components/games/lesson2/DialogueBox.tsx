...
interface DialogueBoxProps {
  ...
  startFull?: boolean;
  /** Dock inside parent (e.g. cinematic column); default fixed to viewport */
  dock?: "viewport" | "panel";
}
...
export default function DialogueBox({
  ...
  const [displayed, setDisplayed] = useState(startFull ? text : "");
  const [phase, setPhase] = useState<"typing" | "done">(startFull ? "done" : "typing");
  ...
  return (
    <motion.div
      ...
      style={{
        position: dock === "panel" ? "absolute" : "fixed",
        bottom: 0,
        left: 0,
        right: 0,
